...
graph_options = ['Data','Invariant Mass', 'Transverse Momentum', 'Pseudorapidity','Total momentum','Transverse momentum of first muon','Transverse momentum of second muon','Best curve fitting for thr first peak','background estimation for the Muon Pair','Full fit','Data','mass histogram and fitted function','Triple Composite Fit','Ratios of second and third peak yield with respect to first peak yield']
...
if file2 is not None:
    data1 = file2.read()
    datalist = np.frombuffer(data1, dtype=np.float32)   
    ...
    file_path = "/Users/manavkumardubey/Desktop/projects/ntcc23/muon-pair-particle-analysis/ups-15-small.bin"  # Provide the actual path to the file
...
# # Monte Carlo Data to find crystall ball params
    ...
    if selected_graph=='mass histogram and fitted function':
        fig,ax=plt.subplots()
    ...
    if selected_graph=='Triple Composite Fit':
    ...
    if selected_graph=='Ratios of second and third peak yield with respect to first peak yield':
    ...
    if selected_graph=='Ratios of second and third peak yield with respect to first peak yield wrt pseudorapidity':
